...
class RouteLineFormModal extends StatefulWidget {
  ...
  const RouteLineFormModal({Key? key, this.route}) : super(key: key);
...
class _RouteLineFormModalState extends State<RouteLineFormModal> {
  ...
  Future<void> _submit() async {
    ...
    try {
      if (widget.route == null) {
        /// CREATE
        await RouteLineService.createRouteLine({"name": nameController.text});
      } else {
        /// UPDATE
        await RouteLineService.updateRouteLine(widget.route!.id, {
