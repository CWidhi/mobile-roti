...
class RuteRemoveUserScreen extends StatefulWidget {
  const RuteRemoveUserScreen({super.key});

  @override
  State<RuteRemoveUserScreen> createState() => _RuteRemoveUserScreenState();
}

class _RuteRemoveUserScreenState extends State<RuteRemoveUserScreen> {
  int? selectedRuteId;
  int? selectedUserId;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Hapus User dari Rute"),
